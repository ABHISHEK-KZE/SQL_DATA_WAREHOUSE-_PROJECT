...
* `Intregation Model` ![alt text](https://github.com/ABHISHEK-KZE/SQL_DATA_WAREHOUSE-_PROJECT/blob/main/docs/integration%20model.drawio/integration%20model.drawio.png?raw=true) 
